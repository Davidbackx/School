			...
			<fieldset>
				...
				<p class="form-group">
					<label class="control-label" for="naam">Naam: </label> <input
						id="naam" name="naam" ${naamErrorClass} type="text" value="${naamPreviousValue}" required novalidate>
				</p>
				<p class="form-group">
					<label class="control-label" for="voornaam">Voornaam: </label> <input
						id="voornaam" name="voornaam" ${voornaamErrorClass} type="text" value="${voornaamPreviousValue}" required novalidate>
				</p>
				<p class="form-group">
					<label class="control-label" for="leeftijd">Leeftijd: </label> <input
						id="leeftijd" name="leeftijd" ${leeftijdErrorClass} type="text" value="${leeftijdPreviousValue}" required novalidate>
				</p>
				<p class="form-group">
					<label class="control-label" for="studierichting">Studierichting: </label> <input
						id="studierichting" name="studierichting" ${studierichtingErrorClass} type="text" value="${studierichtingPreviousValue}" required novalidate>
				</p>
			</fieldset>
			<p>

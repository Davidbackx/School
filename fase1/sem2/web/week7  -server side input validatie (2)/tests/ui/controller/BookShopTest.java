...
public class BookShopTest {
    ...
    @Test
    public void Test_blank_form_throw_exception () {
        driver.get(url);
        driver.findElement(By.id("calculate")).click();
        assertEquals(driver.findElement(By.cssSelector("p")).getText(), "Vul alle velden in.");
    }

    @Test
    public void Test_enter_title_and_price () {
        driver.get(url);

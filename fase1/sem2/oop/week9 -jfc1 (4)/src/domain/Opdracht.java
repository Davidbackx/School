...
public class Opdracht {
	...
	/*
	int id, String vraag, String antwoord,
			boolean hoofdlettergevoelig, String categorie, String auteur
	 */
	public boolean equals(Object object) {
		...
		if (!(object instanceof  Opdracht)) return false;
			...
			if (this.opdrachtID != o.opdrachtID) return false;

			if (this.vraag == null) {
				if (o.vraag!=null) return false;
			}
			else {
				if (!this.vraag.equals(o.vraag)) return false;
			}

			if (this.antwoord == null) {
				if (o.antwoord!=null) return false;
			}
			else {
				if (!this.antwoord.equals(o.antwoord)) return false;
			}

			if (this.auteur == null) {
				if (o.auteur!=null) return false;
			}
			else {
				if (!this.auteur.equals(o.auteur)) return false;
			}

			if (this.categorie == null) {
				if (o.categorie!=null) return false;
			}
			else {
				if (!this.categorie.equals(o.categorie)) return false;
			}

			if (this.antwoordHint == null) {
				if (o.antwoordHint!=null) return false;
			}
			else {
				if (!this.antwoordHint.equals(o.antwoordHint)) return false;
			}

			if (this.isHoofdletterGevoelig != o.isHoofdletterGevoelig) return false;
			return true;
		}
	}
	/**

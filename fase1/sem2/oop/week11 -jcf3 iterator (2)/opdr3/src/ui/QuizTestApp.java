...
public class QuizTestApp {
	...
	public static void main(String[] args) {
		...
		String deelnemers = JOptionPane.showInputDialog(null,"typ namen van de deelnemers gescjeiden door een komma","Maak een deelnemer groep",JOptionPane.QUESTION_MESSAGE);

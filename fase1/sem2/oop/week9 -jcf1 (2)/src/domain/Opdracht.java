...
public class Opdracht {
	...
	public boolean equals(Object object) {
		if (object instanceof Opdracht) {
			...
			if (o.getOpdrachtID() != getOpdrachtID())
				return false;
			if (!o.getVraag().equals(getVraag()))
				return false;
			if (!o.getAntwoord().equals(getAntwoord()))
				return false;
			if (o.isHoofdletterGevoelig() != isHoofdletterGevoelig())
				return false;
			if (!o.getAntwoordHint().equals(getAntwoordHint()))
				return false;
			if (!o.getCategorie().equals(getCategorie()))
				return false;
			if (!o.getAuteur().equals(getAuteur()))
				return false;
			return true;
		}
		return false;
